...
class environment_repository(models.Model):
    ...
    _inherit = 'infrastructure.environment_repository'

    server_id = fields.Many2one('infrastructure.server', string='Server', related='environment_id.server_id')
    branch_ids = fields.Many2many('infrastructure.repository_branch', string='Branches', related='server_repository_id.repository_id.branch_ids', readonly=True)
