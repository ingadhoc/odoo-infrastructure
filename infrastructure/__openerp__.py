...

{
    ...
    'data': [
        ...
        u'view/docker_image_view.xml',
        u'view/server_docker_image_view.xml',
        u'data/cron.xml',
    ...
    'demo': [
        ...
        u'data/demo/infrastructure.odoo_version.csv',
